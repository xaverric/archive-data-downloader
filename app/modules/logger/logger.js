...
const options = {
    fileDebug: {
        level: 'debug',
        filename: path.join(os.homedir(), '.archive-data-downloader', 'logs', 'debug.log'),
...
export const CONSOLE_LOG = winston.createLogger({
    transports: [
...
export const CONSOLE_TIME_LOG = winston.createLogger({
    transports: [
        transports.fileDebug,
